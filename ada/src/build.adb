   ...
   if Print_Help then
      ...
      begin
         while not End_Of_Arguments loop
            ...
            begin
               pragma Debug
                 (Put_Line (Standard_Error, "parsing '" & Argument & "'."));
               ...
               then
                  ...
                  begin
                     if GNAT.Sockets.Is_IPv6_Address
                         (Name => Argument (2 .. Close_Bracket - 1))
                  ...
                  if Ada.Strings.Fixed.Count (Argument, ":") > 1 then
                     raise Format_Error
                       with "'" &
                       Argument (Index (Argument, ":") .. Argument'Last) &
                  ...
                  begin
                     ...
                     then
                        my_tree.Client
                          (GNAT.Sockets.Inet_Addr (Argument (1 .. Colon - 1)),
                           GNAT.Sockets.Port_Type'Value
                             (Argument (Colon + 1 .. Argument'Last)));
                     end if;
                  end;
               end if;
            exception
